...
OpCase(i_get_map_element_frar):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    GetMapElement(r(0), Arg(1), r(0), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_get_map_element_frax):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    GetMapElement(r(0), Arg(1), xb(Arg(2)), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_get_map_element_fray):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    GetMapElement(r(0), Arg(1), yb(Arg(2)), ClauseFail());
    NextPF(3, next);
    }
...
OpCase(i_get_map_element_fxar):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    GetMapElement(xb(Arg(1)), Arg(2), r(0), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_get_map_element_fxax):
    { 
    BeamInstr* next;
    PreFetch(4, next);
    GetMapElement(xb(Arg(1)), Arg(2), xb(Arg(3)), ClauseFail());
    NextPF(4, next);
    }

OpCase(i_get_map_element_fxay):
    { 
    BeamInstr* next;
    PreFetch(4, next);
    GetMapElement(xb(Arg(1)), Arg(2), yb(Arg(3)), ClauseFail());
    NextPF(4, next);
    }
...
OpCase(i_get_map_element_fyar):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    GetMapElement(yb(Arg(1)), Arg(2), r(0), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_get_map_element_fyax):
    { 
    BeamInstr* next;
    PreFetch(4, next);
    GetMapElement(yb(Arg(1)), Arg(2), xb(Arg(3)), ClauseFail());
    NextPF(4, next);
    }

OpCase(i_get_map_element_fyay):
    { 
    BeamInstr* next;
    PreFetch(4, next);
    GetMapElement(yb(Arg(1)), Arg(2), yb(Arg(3)), ClauseFail());
    NextPF(4, next);
    }
...
OpCase(i_has_map_field_fra):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    HasMapField(r(0), Arg(1), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_has_map_field_frr):
    { 
    BeamInstr* next;
    PreFetch(1, next);
    HasMapField(r(0), r(0), ClauseFail());
    NextPF(1, next);
    }

OpCase(i_has_map_field_frx):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    HasMapField(r(0), xb(Arg(1)), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_has_map_field_fry):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    HasMapField(r(0), yb(Arg(1)), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_has_map_field_fxa):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    HasMapField(xb(Arg(1)), Arg(2), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_has_map_field_fxr):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    HasMapField(xb(Arg(1)), r(0), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_has_map_field_fxx):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    HasMapField(xb(Arg(1)), xb(Arg(2)), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_has_map_field_fxy):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    HasMapField(xb(Arg(1)), yb(Arg(2)), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_has_map_field_fya):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    HasMapField(yb(Arg(1)), Arg(2), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_has_map_field_fyr):
    { 
    BeamInstr* next;
    PreFetch(2, next);
    HasMapField(yb(Arg(1)), r(0), ClauseFail());
    NextPF(2, next);
    }

OpCase(i_has_map_field_fyx):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    HasMapField(yb(Arg(1)), xb(Arg(2)), ClauseFail());
    NextPF(3, next);
    }

OpCase(i_has_map_field_fyy):
    { 
    BeamInstr* next;
    PreFetch(3, next);
    HasMapField(yb(Arg(1)), yb(Arg(2)), ClauseFail());
    NextPF(3, next);
    }
